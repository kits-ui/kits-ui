...
`),l("span",{class:"line"})])])],-1),S=g('<hr><h1 id="authcode-api" tabindex="-1">AuthCode API <a class="header-anchor" href="#authcode-api" aria-hidden="true">#</a></h1><table><thead><tr><th>方法名</th><th>说明</th><th>入参</th><th>出参</th><th></th></tr></thead><tbody><tr><td>createCodeHandle</td><td>实例方法 生产验证码</td><td>-</td><td>-</td><td></td></tr></tbody></table><h2 id="authcode-属性" tabindex="-1">AuthCode 属性 <a class="header-anchor" href="#authcode-属性" aria-hidden="true">#</a></h2><table><thead><tr><th>属性名</th><th>说明</th><th>类型</th><th>可选值</th><th>默认值</th></tr></thead><tbody><tr><td>height</td><td>高度</td><td><code>number</code></td><td>-</td><td>36</td></tr><tr><td>width</td><td>宽度</td><td><code>number</code></td><td>-</td><td>90</td></tr><tr><td>count</td><td>随机生成验证码数量</td><td><code>number</code></td><td>-</td><td>4</td></tr><tr><td>codes</td><td>自定义生成的验证码</td><td><code>array</code></td><td>-</td><td>[]</td></tr></tbody></table>',5);function $(e,n,u,A,d,a){const c=F("render-demo-0"),r=F("demo");return b(),k("div",null,[x,V,N,H,f(r,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:h(()=>[I]),default:h(()=>[f(c)]),_:1}),S])}const U=_(w,[["render",$]]);export{O as __pageData,U as default};
