import{V as p,_ as x,r as B,o as O,c as w,a as m,w as b,b as l,d as s,e as _}from"./app.7ba7b0e0.js";const{defineComponent:g}=p,V=g({name:"component-doc",components:{"render-demo-0":function(){const{createElementVNode:i,resolveComponent:E,createVNode:r,openBlock:A,createElementBlock:u}=p;function F(o,e){const t=E("k-context-menu");return A(),u("div",null,[i("div",{class:"k-contextMenu-box",onContextmenu:e[0]||(e[0]=(...n)=>o.rightClick1&&o.rightClick1(...n))},"组件右击方式打开菜单",32),r(t,{open:o.isOpen1,"onUpdate:open":e[1]||(e[1]=n=>o.isOpen1=n),event:o.eventVal,menus:o.menusOtions.menus},null,8,["open","event","menus"]),r(t,{open:o.isOpen3,"onUpdate:open":e[2]||(e[2]=n=>o.isOpen3=n),event:o.eventVal,menus:o.menusOtions.menus},null,8,["open","event","menus"])])}const{defineComponent:y}=p,{nextTick:a,ref:c,shallowRef:D}=p;return{render:F,...y({setup(o,{expose:e}){e();const t=[{label:"返回(B)",tip:"Alt+向左箭头",click:()=>{window.history.back()}},{label:"点击不关闭菜单",tip:"不关闭菜单",click:()=>!1},{label:"前进(F)",tip:"Alt+向右箭头",disabled:!0},{label:"重新加载(R)",tip:"Ctrl+R",click:()=>location.reload(),divided:!0},{label:"另存为(A)...",tip:"Ctrl+S"},{label:"打印(P)...",tip:"Ctrl+P",click:()=>window.print()},{label:"投射(C)...",divided:!0},{label:"发送到你的设备",children:[{label:"iPhone"},{label:"iPad"},{label:"Windows 11"}]},{label:"为此页面创建二维码",divided:!0},{label:"使用网页翻译(F)",divided:!0,children:[{label:"翻译成繁体中文"},{label:"翻译成繁体中文"},{label:"百度翻译"},{label:"搜狗翻译"},{label:"有道翻译"}]},{label:"截取网页(R)"},{label:"查看网页源代码(U)",tip:"Ctrl+U"},{label:"检查(N)",tip:"Ctrl+Shift+I"}],n=c(!1),v=c(!1),C=c({});function h(f){n.value=!1,a(()=>{C.value=f,n.value=!0}),f.preventDefault()}const k=D({menus:t}),d={menus:t,isOpen1:n,isOpen3:v,eventVal:C,rightClick1:h,menusOtions:k,nextTick:a,ref:c,shallowRef:D};return Object.defineProperty(d,"__isScriptSetup",{enumerable:!1,value:!0}),d}})}}()}}),I=JSON.parse('{"title":"鼠标右击弹窗","description":"","frontmatter":{},"headers":[{"level":2,"title":"基础用法","slug":"基础用法","link":"#基础用法","children":[]}],"relativePath":"components/contextMenu/index.md"}'),P=l("h1",{id:"鼠标右击弹窗",tabindex:"-1"},[s("鼠标右击弹窗 "),l("a",{class:"header-anchor",href:"#鼠标右击弹窗","aria-hidden":"true"},"#")],-1),S=l("h2",{id:"基础用法",tabindex:"-1"},[s("基础用法 "),l("a",{class:"header-anchor",href:"#基础用法","aria-hidden":"true"},"#")],-1),R=l("div",{class:"language-vue"},[l("pre",{"v-pre":"",class:"shiki rose-pine-moon vp-code-dark",tabindex:"0"},[l("code",null,[l("span",{class:"line"},[l("span",{style:{color:"#6E6A86"}},"<"),l("span",{style:{color:"#9CCFD8"}},"template"),l("span",{style:{color:"#6E6A86"}},">")]),s(`
...
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"    divided"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#EA9A97"}},"true")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"  "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"  "),l("span",{style:{color:"#908CAA"}},"{")]),s(`
...
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"{"),l("span",{style:{color:"#E0DEF4"}}," label"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#F6C177"}},"'翻译成繁体中文'"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"        label"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#F6C177"}},"'百度翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"        label"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#F6C177"}},"'搜狗翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"        label"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#F6C177"}},"'有道翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"      "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"    ]"),l("span",{style:{color:"#908CAA"}},",")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"  "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"  "),l("span",{style:{color:"#908CAA"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"    label"),l("span",{style:{color:"#908CAA"}},":"),l("span",{style:{color:"#E0DEF4"}}," "),l("span",{style:{color:"#F6C177"}},"'截取网页(R)'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#E0DEF4"}},"  "),l("span",{style:{color:"#908CAA"}},"},")]),s(`
...
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"    divided"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#D7827E"}},"true")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"  "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"  "),l("span",{style:{color:"#797593"}},"{")]),s(`
...
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"{"),l("span",{style:{color:"#575279"}}," label"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#EA9D34"}},"'翻译成繁体中文'"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"        label"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#EA9D34"}},"'百度翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"        label"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#EA9D34"}},"'搜狗翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"        label"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#EA9D34"}},"'有道翻译'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"      "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"    ]"),l("span",{style:{color:"#797593"}},",")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"  "),l("span",{style:{color:"#797593"}},"},")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"  "),l("span",{style:{color:"#797593"}},"{")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"    label"),l("span",{style:{color:"#797593"}},":"),l("span",{style:{color:"#575279"}}," "),l("span",{style:{color:"#EA9D34"}},"'截取网页(R)'")]),s(`
`),l("span",{class:"line"},[l("span",{style:{color:"#575279"}},"  "),l("span",{style:{color:"#797593"}},"},")]),s(`
...
<\/script>
`},{highlight:b(()=>[R]),default:b(()=>[m(y)]),_:1}),T])}const M=x(V,[["render",N]]);export{I as __pageData,M as default};
