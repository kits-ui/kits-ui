...
`),l("span",{class:"line"},[l("span",{style:{color:"#9893A5"}},"</"),l("span",{style:{color:"#56949F"}},"script"),l("span",{style:{color:"#9893A5"}},">")])])])],-1),B=b("",3),g=JSON.parse('{"title":"鼠标右击弹窗","description":"","frontmatter":{},"headers":[],"relativePath":"components/contextMenu/index.md","filePath":"components/contextMenu/index.md"}'),O={name:"components/contextMenu/index.md"},P=Object.assign(O,{setup(d){return(y,o)=>{const n=F("demo");return C(),D("div",null,[x,k,t(n,{customClass:"",sourceCode:`<template>
  <div>
