...
`),s("span",{class:"line"},[s("span",{style:{color:"#9893A5"}},"</"),s("span",{style:{color:"#56949F"}},"script"),s("span",{style:{color:"#9893A5"}},">")])])])],-1),m=D("",5),v=JSON.parse('{"title":"搜索面板","description":"","frontmatter":{},"headers":[],"relativePath":"components/filterBox/index.md","filePath":"components/filterBox/index.md"}'),h={name:"components/filterBox/index.md"},x=Object.assign(h,{setup(r){return(n,a)=>{const o=t("demo");return p(),d("div",null,[C,f,e(o,{customClass:"",sourceCode:`<template>
