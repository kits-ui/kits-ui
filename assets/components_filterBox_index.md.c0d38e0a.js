...
`),s("span",{class:"line"})])])],-1),k=b('<h2 id="filter-api" tabindex="-1">Filter API <a class="header-anchor" href="#filter-api" aria-hidden="true">#</a></h2><h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-hidden="true">#</a></h2><table><thead><tr><th>属性名</th><th>说明</th><th>类型</th><th>可选值</th><th>默认值</th></tr></thead><tbody><tr><td>filterData</td><td>filterData 的数据</td><td><code>Array</code></td><td>-----------</td><td>-</td></tr></tbody></table><h2 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-hidden="true">#</a></h2><table><thead><tr><th>方法</th><th>说明</th><th>参数</th></tr></thead><tbody><tr><td>onSelectData</td><td>获取所选标签的 id 集合的回调</td><td>--</td></tr></tbody></table>',5);function S(a,c,t,p,r,e){const y=D("render-demo-0"),o=D("demo");return B(),f("div",null,[_,v,d(o,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{highlight:u(()=>[x]),default:u(()=>[d(y)]),_:1}),k])}const N=F(h,[["render",S]]);export{V as __pageData,N as default};
