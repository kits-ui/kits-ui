...
`),s("span",{class:"line"},[s("span",{style:{color:"#575279"}},"  "),s("span",{style:{color:"#9893A5"}},"</"),s("span",{style:{color:"#56949F"}},"div"),s("span",{style:{color:"#9893A5"}},">")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#9893A5"}},"</"),s("span",{style:{color:"#56949F"}},"template"),s("span",{style:{color:"#9893A5"}},">")]),l(`
`),s("span",{class:"line"})])])],-1),$=s("h2",{id:"内置-icon-持续补充中",tabindex:"-1"},[l("内置 Icon(持续补充中...) "),s("a",{class:"header-anchor",href:"#内置-icon-持续补充中","aria-hidden":"true"},"#")],-1);function O(a,o,n,c,i,u){const E=A("render-demo-0"),t=A("demo"),p=A("render-demo-1"),r=A("Icons");return v(),b("div",null,[V,y(t,{customClass:"undefined",sourceCode:`<template>
  <div>
    <back />
    <edit />
    <earth />
...
`},{highlight:F(()=>[N]),default:F(()=>[y(E)]),_:1}),I,w,y(t,{customClass:"undefined",sourceCode:`<template>
